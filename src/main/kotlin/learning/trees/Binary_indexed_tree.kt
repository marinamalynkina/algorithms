...
fun main(args: Array<String>) {
    val freq = intArrayOf(2, 1, 1, 3, 2, 3, 4, 5, 6, 7, 8, 9)
    val n = freq.size
...
internal class BinaryIndexedTree(val n: Int) {
    ...
    lateinit var BITree: IntArray
    init {
        BITree = IntArray(n+1) {0}
    }
...
//        for (i in 1..n) BITree[i] = 0

        // Store the actual values in BITree[]
        // using update()
        for (i in 0 until n) updateBIT(n, i, arr[i])
    }
